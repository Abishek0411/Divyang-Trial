    ...
    return (
        <View style={styles.container}>
            <View style={styles.contentContainer}>
                <Text style={styles.h3}>If you want to consult a cardiologist for further details</Text>
                <Text style={styles.h2}>Nearby Cardiologists:</Text>
                <TouchableOpacity style={styles.button}>
                    <Image
                        source={require('./assets/3.png')} // Replace with your local PNG path
